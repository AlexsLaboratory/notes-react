...
const Input: FunctionComponent<Props> = (props) => {
    ...
    return (
        <div className={inputStyles["input-group"]}>
            ...
            <input className={`${inputStyles["input-group__input"]} ${props.hasError ? `${inputStyles["input-group__input--error"]}` : ""}`} type={props.type} name={props.name} id={props.name} onChange={props.onChange} onBlur={props.onBlur} value={props.value}/>
